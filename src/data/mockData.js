...
export const DASHBOARD_STATS = {
  [ROLES.SUPER_ADMIN]: [
    { label: "Total Tenants", value: "18", delta: "+2 this month", tone: "up", to: "/app/agencies" },
    { label: "Active Leads", value: "1,204", delta: "+8.4%", tone: "up", to: "/app/leads" },
    { label: "Platform Revenue", value: "₹42.8 L", delta: "+12%", tone: "up", to: "/app/payments" },
    { label: "System Uptime", value: "99.98%", delta: "Stable", tone: "flat", to: "/app/settings" },
  ],
  [ROLES.ADMIN]: [
    { label: "New Leads (7d)", value: "186", delta: "+14%", tone: "up", to: "/app/leads" },
    { label: "Active Listings", value: "312", delta: "+6", tone: "up", to: "/app/properties" },
    { label: "Deals Closed", value: "24", delta: "+3", tone: "up", to: "/app/deals" },
    { label: "Revenue (MTD)", value: "₹6.2 Cr", delta: "+9%", tone: "up", to: "/app/payments" },
  ],
  [ROLES.AGENCY_ADMIN]: [
    { label: "Agency Leads", value: "96", delta: "+11%", tone: "up", to: "/app/leads" },
    { label: "Active Brokers", value: "8", delta: "0", tone: "flat", to: "/app/brokers" },
    { label: "Deals in Pipeline", value: "17", delta: "+2", tone: "up", to: "/app/deals" },
    { label: "Conversion Rate", value: "16.4%", delta: "+1.2%", tone: "up", to: "/app/reports" },
  ],
  [ROLES.BROKER]: [
    { label: "My Leads", value: "34", delta: "+5", tone: "up", to: "/app/leads" },
    { label: "Follow-ups Due", value: "7", delta: "Today", tone: "warn", to: "/app/tasks" },
    { label: "Deals Won", value: "6", delta: "This quarter", tone: "flat", to: "/app/deals" },
    { label: "Commission (MTD)", value: "₹1.8 L", delta: "+22%", tone: "up", to: "/app/payments" },
  ],
  [ROLES.BUILDER]: [
    { label: "Active Projects", value: "4", delta: "1 launching", tone: "flat", to: "/app/builders" },
    { label: "Units Available", value: "212 / 320", delta: "66%", tone: "flat", to: "/app/properties" },
    { label: "Inquiries (7d)", value: "58", delta: "+9%", tone: "up", to: "/app/leads" },
    { label: "Bookings (MTD)", value: "11", delta: "+4", tone: "up", to: "/app/deals" },
  ],
  [ROLES.SALES]: [
    { label: "Assigned Leads", value: "42", delta: "+6", tone: "up", to: "/app/leads" },
    { label: "Overdue Follow-ups", value: "3", delta: "Act now", tone: "warn", to: "/app/tasks" },
    { label: "Site Visits Booked", value: "9", delta: "This week", tone: "flat", to: "/app/tasks" },
    { label: "Conversion Rate", value: "19%", delta: "+2%", tone: "up", to: "/app/reports" },
  ],
};
